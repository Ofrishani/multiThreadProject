...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private MessageBrokerImpl msgBroker;
    ...
    public Subscriber(String name) {
        ...
        msgBroker = (MessageBrokerImpl) MessageBrokerImpl.getInstance();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        msgBroker.subscribeEvent(type, this);
    }
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        callBackMap.putIfAbsent(type,callback);
        msgBroker.subscribeBroadcast(type, this);
    }
    ...
    public final void run() {
        ...
        initialize();
        MI6Runner.letch.countDown();
        while (!terminated) {
            try{
                Message mess = msgBroker.awaitMessage(this);
                Callback currentCull = callBackMap.get(mess.getClass());
                currentCull.call(mess);
            } catch (InterruptedException ignored){}
        }
        msgBroker.unregister(this);
    }
}
